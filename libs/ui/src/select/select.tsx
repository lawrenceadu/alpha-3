...
const SelectTrigger = ({
  ...
  ref?: React.Ref<React.ComponentRef<typeof SelectPrimitives.Trigger>>;
}) => {
...
const SelectContent = ({
  ...
  ref?: React.Ref<React.ComponentRef<typeof SelectPrimitives.Content>>;
}) => (
...
const SelectItem = ({
  ...
  ref?: React.Ref<React.ComponentRef<typeof SelectPrimitives.Item>>;
}) => {
